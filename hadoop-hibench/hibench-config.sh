...
export HADOOP_EXAMPLES_JAR=/root/hadoop/share/hadoop/mapreduce/hadoop-mapreduce-examples-2.7.1.jar
export MAPRED_EXECUTABLE=hadoop
#Set the varaible below only in YARN mode
export HADOOP_JOBCLIENT_TESTS_JAR=/root/hadoop/share/hadoop/mapreduce/hadoop-mapreduce-client-jobclient-2.7.1-tests.jar
